...
def generate_launch_description():
    ...
    # Note: 'name' must match what you use in 'scenario:=...'
    # Note: 'default_value' is what it falls back to if you forget it
    ...
    predictor_node = Node(
        ...
        # The key on the left MUST match the name in your self.declare_parameter()
        parameters=[{
